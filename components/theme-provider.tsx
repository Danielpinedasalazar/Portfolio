...
const themes: Record<string, Theme> = {
  cyberpunk: {
    ...
    backgroundAlt: "bg-gradient-to-br from-purple-900 via-pink-900 to-slate-900",
  ...
  sunset: {
    ...
    backgroundAlt: "bg-gradient-to-br from-red-900 via-purple-900 to-orange-900",
  ...
  ocean: {
    ...
    buttonGradient: "from-blue-500 to-teal-600 hover:from-blue-600 hover:to-teal-700",
  ...
  aurora: {
    ...
    backgroundAlt: "bg-gradient-to-br from-blue-900 via-green-900 to-purple-900",
    ...
    buttonGradient: "from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700",
  ...
  cosmic: {
    ...
    backgroundAlt: "bg-gradient-to-br from-purple-900 via-pink-900 to-indigo-900",
